...
export default function Credits() {
  ...
  return (
    <div className="min-h-screen bg-paper text-ink font-serif flex flex-col items-center justify-center">
      <div className="flex flex-col items-center space-y-10 w-64 text-center">
        ...
        <button
          onClick={() => navigate('/')}
          className="py-3 w-full border border-gold/40 text-ink hover:border-gold hover:text-gold tracking-widest transition-all cursor-pointer text-sm"
        >
          返回
        </button>
      </div>
