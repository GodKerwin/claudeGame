      ...
      <div className="max-w-md w-full relative z-10">
        ...
        >
          ...
          <button
            ...
            className={`border border-gold/50 text-gold/80 px-12 py-2.5 text-sm tracking-[0.3em] transition-all duration-300 hover:border-gold hover:text-gold ${showButton ? 'cursor-pointer' : 'pointer-events-none'}`}
